    ...
    this.shadowRoot!.innerHTML = `
      ...
      <div class="panel">
        ...
        ${this.isOpen ? `
          ...
          <div class="content">
            <vl-${this.activeTab}-tab></vl-${this.activeTab}-tab>
          </div>

          <div class="footer">
            <a class="softcode-link" href="https://softcode.fr/" target="_blank" rel="noopener noreferrer">
...
customElements.define('vue-lens-panel', VueLensPanel)